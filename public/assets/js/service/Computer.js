  ...
  <form id="formeditcomputer" action="index.php?page=manage&r=computer" method="post">
       ...
       <div class="row">
           <div class="typepc">
               ...
               <label for="desktop">Desktop</label>
               <input type="radio" id="desktop" name="typepc" value="desktop" readonly class="input-disable" >
           </div>
       </div>
       <div class="row">
           <div>
   ...
   <div class="header">
      ...
      <form >
           <div class="row">
               <div class="typepc">
                   <label for="notebook">Notebook</label>
                   <input type="radio" id="notebook" name="typepc" value="notebook" checked disabled>
               
                   <label for="desktop">Desktop</label>
                   <input type="radio" id="desktop" name="typepc" value="desktop" disabled class="input-disable" >
               </div>
           </div>
           <div class="row">
               <div>
