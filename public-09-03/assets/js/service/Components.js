...
//  }
 ...
 document.querySelector('#addnewcomponents').addEventListener('click', () =>{
     ...
     <form id="formnewcomponents" action="index.php?page=manage&route=components" method="post">
    ...
    //  getLastDateClean(data.historico);
     ...
     <form id="formeditcomponents" action="index.php?page=manage&route=components" method="post">
     ...
     <form id="formeditcomponents" action="index.php?page=manage&route=components" method="post">
      ...
      <div>
        ...
        <div class="row row-button">
            ...
            <a href="index.php?page=manage&route=components&codigo=${data.codigo}&id=${data.id_cpnt}"  class="btn btn-danger"> Apagar </a>
